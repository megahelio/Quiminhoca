export default function Terms() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Quiminhoca.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Quiminhoca, accessible from{" "}
            <a
              href="http://quiminhoca.com"
      ...
      <ul>
        <li>By email: office@example.com</li>
      </ul>
    </div>
  );
}
